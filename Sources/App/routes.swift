...
public func routes(_ router: Router) throws {
    ...
    router.group("api", "v1") { router in
        ...
        authenticated.get("manufacturers", Manufacturer.parameter, "models", "draft", use: manufacturerController.modelsDraft)
        ...
        authenticated.get("models", CarModel.parameter, "images", "draft", use: carModelController.imagesDraft)
        router.get("models", CarModel.parameter, "stages", use: carModelController.stages)
        authenticated.get("models", CarModel.parameter, "stages", "draft", use: carModelController.stagesDraft)
        ...
        authenticated.get("stages", CarStage.parameter, "timings", "draft", use: carStageController.timingsDraft)
